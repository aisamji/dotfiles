...
4. Commit the changes with a message with format below.
5. After The changes have been committed, display the entire commit message. If any sections were skipped, explain why in a single sentence per skipped section.
